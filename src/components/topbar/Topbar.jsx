    ...
    <div className="topbar">
      <div className='flex flex-row justify-around items-center'>
        ...
        <div className='flex flex-col items-center justify-center '>
          <span className='text-xl flex justify-center items-center'>Tata Consultancy Services </span>
      ...
      <div className='flex bg-gray-800 justify-around text-white h-8 items-center'>
        ...
        <div className='flex items-center justify-end'>
          ...
          <span className='flex items-center  justify-end'>View Instructions</span>
        </div>
      </div>
    </div>
  );
